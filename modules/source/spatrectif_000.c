...
int spatrectif_000(int argc, void* argv[])
{
  ...
  // Copy over the influence matrix into the fbv variable.
  for (sp=0; sp<numspec; sp++)
  ...
  for (sp=0; sp<numspec; sp++)
   ...
   writefitsimagefile("/Users/aboehle/research/irlab/projects/osiris_spatrectif_tests/img_output/blame.fits", FLOAT_IMG, 3, naxes_blame, blame);
   writefitsimagefile("/Users/aboehle/research/irlab/projects/osiris_spatrectif_tests/img_output/fblame.fits", FLOAT_IMG, 3, naxes_blame, fblame);
  ...
  for (ii=0; ii<numiter; ii++)
	...
	{ // for each spectral channel i ... (i.e., for a given column)
	  ...
	  for ( sp=0; sp<numspec; sp++ )
	      ...
	      for ( jj=0; jj<MAXSLICE; jj++ )
		{
		  ...
		  if ( ii < 15 ) {
		    ...
		    ti[sp]+=relax*residual[j]* bl[jj];
                    currguess_3d[i][sp][jj] = relax*residual[j]* bl[jj];
                    currguess_2d[i][sp] = ti[sp];
      ...
      writefitsimagefile("/Users/aboehle/research/irlab/projects/osiris_spatrectif_tests/img_output/residuals_2d.fits", FLOAT_IMG, 2, naxes_resid, residuals_2d);
      writefitsimagefile("/Users/aboehle/research/irlab/projects/osiris_spatrectif_tests/img_output/currguess_2d.fits", FLOAT_IMG, 2, naxes_guess, currguess_2d);
      writefitsimagefile("/Users/aboehle/research/irlab/projects/osiris_spatrectif_tests/img_output/currguess_3d.fits", FLOAT_IMG, 3, naxes_blame, currguess_3d);
